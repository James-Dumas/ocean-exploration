...
execute as @a[nbt={Inventory:[{Slot:17b,id:"minecraft:diamond_hoe",tag:{display:{Name:'{"text":"Oxygen Tank"}'}}}]}] run scoreboard players set @s WearingTank 1
execute as @a[nbt={Inventory:[{Slot:17b,id:"minecraft:diamond_hoe",tag:{display:{Name:'{"text":"Oxygen Tank"}'}}}]}] run scoreboard players set @s MaxOxygen 2000
execute as @a[nbt={Inventory:[{Slot:17b,id:"minecraft:diamond_hoe",tag:{display:{Name:'{"text":"Advanced Oxygen Tank"}'}}}]}] run scoreboard players set @s WearingTank 1
execute as @a[nbt={Inventory:[{Slot:17b,id:"minecraft:diamond_hoe",tag:{display:{Name:'{"text":"Advanced Oxygen Tank"}'}}}]}] run scoreboard players set @s MaxOxygen 5000
...
execute as @a[nbt=!{ActiveEffects:[{Id:29b}]},nbt={Inventory:[{Slot:103b,id:"minecraft:chainmail_helmet",tag:{display:{Name:'{"text":"Scuba Mask"}'}}}]}] unless score @s Air matches 300 if score @s WearingTank matches 1 unless score @s OxygenTank matches 0 run scoreboard players set @s UseOxygen 1
execute as @a[nbt=!{ActiveEffects:[{Id:29b}]},nbt={Inventory:[{Slot:103b,id:"minecraft:iron_helmet",tag:{display:{Name:'{"text":"Rebreather"}'}}}]}] unless score @s Air matches 300 if score @s WearingTank matches 1 unless score @s OxygenTank matches 0 run scoreboard players set @s UseOxygen 1
